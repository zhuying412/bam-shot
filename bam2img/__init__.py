...
def bam2img(bam: str, ref: str, chrom: str, start: int, end: int, extend: int, img: Union[str, io.BytesIO], depth: Optional[int] = None, title: str = "", ref_with_ins=False, dpi: int = 200):
